...
import getExpensGroupByType from '@salesforce/apex/ExpenseController.getExpensGroupByType';
/**
...
export default class ExpensesChartjs extends LightningElement {
    ...
    async renderedCallback() {
        ...
        try {
            ...
            let result = await getExpensGroupByType({startDate: this.startDate, endDate: this.endDate});
